    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-50">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">Escala Militar Pro</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {!isLogin && (
            <div className="space-y-1">
              <label className="text-xs font-bold text-slate-400 font-bold uppercase tracking-wider ml-1">Nome Completo</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 pl-10 pr-4 text-slate-900 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all font-medium"
          ...
          {error && (
            <p className={`text-sm text-center font-bold ${error.includes('sucesso') ? 'text-green-600' : 'text-red-600'}`}>
              {error}
            </p>
          )}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-500 text-white font-black py-4 rounded-xl shadow-lg shadow-blue-600/20 flex items-center justify-center gap-2 active:scale-[0.98] transition-all disabled:opacity-50"
          >
